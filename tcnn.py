...
class YOLO_V1(nn.Module):
    def __init__(self, rnn_type="TCNN"):
        ...
        self.tcnn = tcnnlayer.TCNN(8, 8, 2, 1, 3//2, 1, dropout=0.2)
    ...
    def forward(self, input, same_shape=False):
        ...
        if(same_shape):
            return self.squeeze2(output, seqLen)
        else:
            return output
